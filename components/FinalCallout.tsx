...
export default function FinalCallout() {
  return (
    <div className="w-full py-24 sm:py-32 relative">
      <div className="container">
        <motion.div
          ...
          className="group relative mx-auto max-w-[31.25rem] overflow-hidden rounded-3xl border bg-card/90 p-[3.125rem] text-center shadow-sm transition-transform duration-300 hover:scale-[1.02] final-callout-border-glow"
          style={{ borderColor: "rgba(167,139,250,.55)", boxShadow: "0 0 0 1px rgba(167,139,250,.55) inset" }}
        >
          {/* Боковое свечение ЗА плашкой */}
          <div aria-hidden className="pointer-events-none absolute -left-[15rem] top-1/2 -translate-y-1/2 -z-10">
          ...
          <div aria-hidden className="pointer-events-none absolute -right-[15rem] top-1/2 -translate-y-1/2 -z-10">
          ...
          <motion.span
            ...
            viewport={{ once: false, amount: 0.5 }}
            className="pointer-events-none absolute bottom-5 left-6 z-10 text-sm text-white/60 text-[1rem]"
          >
          ...
          <motion.span
            ...
            transition={{ delay: 0.15, duration: 0.5, ease: "easeOut" }}
            viewport={{ once: false, amount: 0.5 }}
            className="pointer-events-none absolute top-5 right-5 z-10 text-sm text-white/60 text-[1rem]"
          >
            54.7431, 55.9678
          </motion.span>
          ...
          <motion.h2
            ...
            className="relative z-10 text-[3rem] sm:text-[3.75rem] font-extrabold tracking-[-0.09em] [font-family:var(--ff-exotica)]"
          >
            I can be your joker
          </motion.h2>
          <motion.div
            ...
            viewport={{ once: false, amount: 0.6 }}
            className="relative z-10 mt-[0.5rem] flex items-center justify-center gap-4"
          >
            {/* Telegram */}
            <Link
              href={profile.links.telegram}
              aria-label="Open Telegram"
              className="group/icon inline-flex h-[3.75rem] w-[3.75rem] items-center justify-center rounded-full border border-white/10 bg-white/5 transition-all duration-200 hover:bg-sky-400 hover:scale-105 hover:ring-2 hover:ring-sky-400/60 hover:ring-offset-2 hover:ring-offset-[hsl(var(--bg))] hover:shadow-[0_0_24px_rgba(56,189,248,0.65)]"
            >
            ...
            <Link
              ...
              className="inline-flex h-[3.75rem] w-[3.75rem] items-center justify-center rounded-full border border-white/10 bg-white/5 text-white transition-all duration-200 hover:bg-white hover:text-black hover:scale-105 hover:ring-2 hover:ring-white/60 hover:ring-offset-2 hover:ring-offset-[hsl(var(--bg))]"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <Link
              ...
              className="group inline-flex h-[3.75rem] w-[3.75rem] items-center justify-center rounded-full border border-white/10 bg-white/5 text-[#FFA116] transition-all duration-200 hover:bg-[#FFA116] hover:text-black hover:scale-105 hover:ring-2 hover:ring-[#FFA116]/60 hover:ring-offset-2 hover:ring-offset-[hsl(var(--bg))]"
              target="_blank"
              rel="noreferrer"
            >
