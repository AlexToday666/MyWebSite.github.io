    ...
    <div className="w-full py-12 sm:py-24 md:py-32 relative">
      <div className="container px-4 sm:px-6">
        <motion.div
          ...
          className="group relative mx-auto max-w-[31.25rem] overflow-hidden rounded-2xl sm:rounded-3xl border bg-card/90 p-6 sm:p-8 md:p-[3.125rem] text-center shadow-sm transition-transform duration-300 hover:scale-[1.02] final-callout-border-glow"
        ...
        >
          ...
          <motion.h2
            ...
            className="relative z-10 text-2xl sm:text-[3rem] md:text-[3.75rem] font-extrabold tracking-[-0.09em] [font-family:var(--ff-exotica)]"
          >
            I can be your joker
          </motion.h2>
          <motion.div
            ...
            viewport={{ once: false, amount: 0.6 }}
            className="relative z-10 mt-3 sm:mt-[0.5rem] flex items-center justify-center gap-3 sm:gap-4"
          >
            {/* Telegram */}
            <Link
              href={profile.links.telegram}
              aria-label="Open Telegram"
              className="group/icon inline-flex h-12 w-12 sm:h-14 sm:w-14 md:h-[3.75rem] md:w-[3.75rem] items-center justify-center rounded-full border border-white/10 bg-white/5 transition-all duration-200 hover:bg-sky-400 hover:scale-105 hover:ring-2 hover:ring-sky-400/60 hover:ring-offset-2 hover:ring-offset-[hsl(var(--bg))] hover:shadow-[0_0_24px_rgba(56,189,248,0.65)]"
            >
              <svg aria-hidden className="w-5 h-5 sm:w-6 sm:h-6 text-sky-400 transition-colors duration-200 group-hover/icon:text-black" viewBox="0 0 24 24" fill="currentColor">
            ...
            <Link
              ...
              className="inline-flex h-12 w-12 sm:h-14 sm:w-14 md:h-[3.75rem] md:w-[3.75rem] items-center justify-center rounded-full border border-white/10 bg-white/5 text-white transition-all duration-200 hover:bg-white hover:text-black hover:scale-105 hover:ring-2 hover:ring-white/60 hover:ring-offset-2 hover:ring-offset-[hsl(var(--bg))]"
              target="_blank"
              rel="noreferrer"
            >
              <svg aria-hidden className="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 24 24" fill="currentColor">
            ...
            <Link
              ...
              className="group inline-flex h-12 w-12 sm:h-14 sm:w-14 md:h-[3.75rem] md:w-[3.75rem] items-center justify-center rounded-full border border-white/10 bg-white/5 text-[#FFA116] transition-all duration-200 hover:bg-[#FFA116] hover:text-black hover:scale-105 hover:ring-2 hover:ring-[#FFA116]/60 hover:ring-offset-2 hover:ring-offset-[hsl(var(--bg))]"
              target="_blank"
              rel="noreferrer"
            >
              <svg aria-hidden className="w-5 h-5 sm:w-6 sm:h-6 transition-colors duration-200" viewBox="0 0 24 24" fill="currentColor">
